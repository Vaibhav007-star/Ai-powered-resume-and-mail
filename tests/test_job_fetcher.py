...
from backend.job_fetcher import (
    strip_html_tags,
    fetch_from_jobicy,
    fetch_from_remotive,
...
@patch("backend.job_fetcher._make_http_request")
...
@patch("backend.job_fetcher.fetch_from_internshala")
@patch("backend.job_fetcher.fetch_from_remotive")
@patch("backend.job_fetcher.fetch_from_jobicy")
@patch("backend.job_fetcher.fetch_from_arbeitnow")
