...
def generate_application_email(
    ...
    """
    Generates a personalized, professional application email.
    Enforces strict truthfulness and human, concise tone.
    """
...
"""
    ...
    # Clean unicode hyphens/dashes for consistent display
...
def _generate_truthful_fallback(
    ...
    """
    Deterministic composer that constructs a truthful, natural email
    using verified candidate data.
    """
    ...
    # Paragraph 2: Specific Project or Experience
    ...
    # Paragraph 3: Availability & Closing
    closing = (
